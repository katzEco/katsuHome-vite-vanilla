(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerpolicy&&(i.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?i.credentials="include":o.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();const p="https://avatars.githubusercontent.com/u/25049577?v=4",g="Suphakit Pinyoworapot",b="Suphakit P.",x="Just a Computer Engineering Student w/ some music composing skill. :3",v={bYear:2002,eduProfile:[{grade:"Kintergarden - Grade 6",class:"",school:"Darasamutr Sriracha School",duration:"2005 - 2014"},{grade:"Grade 7-9",class:"MEP",school:"Sriracha School",duration:"2014 - 2018"},{grade:"Grade 10",class:"Sci-Math",school:"Piboonbumpen Demonstration School",duration:"2018 - 2019"},{grade:"Grade 11-12",class:"Sci-Math",school:"Darasamutr Sriracha School",duration:"2019 - April 2021"},{grade:"Bachelor's degree",class:"Computer Engineering",school:"University of Phayao",duration:"May 2021 - Present"}],skills:{programming:["HTML5","CSS3","Bootstrap","Tailwind.css","PHP","Javascript","TypeScript","React.js","Vue.js","Nuxt.js","Express.js"],musicComposing:["Producing","Vocaling","Mastering","Composing","Arranging"]},events:[{name:"TESA Top Gun Rally #16",desp:"5-10 Sept. 2022 @ Chitralada Technology Institute",image:"https://ksrc.suphakit.net/1662866532553/000001.jpg"}],certificates:[{name:"TESA Top Gun Rally #16",desp:"Participate in TESA Top Gun Rally #16",image:""}]},y={musicComposing:[{name:"Let me make a song for you.",desp:"This is a commission for composing a song like 'a theme song' or other type of song",price:"Start @ 1000 THB",example:[{name:"katsu.json - a luv.ly day",link:"https://youtu.be/QjwCHzxqfmE"}]}]},w=[{name:"E-Mail",link:"mailto:me@suphakit.net",bgColor:"#ff6f61",tColor:"whitesmoke"},{name:"Github",link:"https://github.com/dethMastery",bgColor:"#2e2f2f",tColor:"whitesmoke"},{name:"Discord",link:"https://did.000198.xyz/@298415109359796234",bgColor:"#7289da",tColor:"whitesmoke"},{name:"Facebook",link:"https://fb.com/detzz.in.th",bgColor:"#2f89fe",tColor:"whitesmoke"},{name:"Twitter",link:"https://twitter.com/georgeKdeterk",bgColor:"#1c9aee",tColor:"whitesmoke"}],$={"?":"🤍",year:2023,holder:"Suphakit P.",holderLink:"https://suphakit.net/"},r={image:p,name:g,sName:b,quote:x,about:v,commission:y,contact:w,copyright:$};function k(t){let e="",s;return t.forEach(a=>{t.class==""?s=`[${a.grade}] - ${a.school} [${a.duration}]`:s=`[${a.grade}] - ${a.class} ${a.school} [${a.duration}]`,e!=""?e=e+`<li class="mb-[.5rem]">${s}</li>`:e=`<li class="mb-[.5rem]">${s}</li>`}),e}function m(t){let e="";return t.forEach(s=>{e!=""?e=e+", "+s:e=s}),e}function C(t){let e="";return t.forEach(s=>{let a=`<div class="cardEvent">
  ...
  <div class="cardBody">
...
</div>`;e!=""?e=e+a:e=a}),e}let d="w-[100%] flex flex-col md:flex-row",S="w-[100%] mb-[5rem]",l="text-2xl mb-[1rem] underline",u="text-xl mb-[1rem] underline";function f(){let t="block w-full basis-1/2 py-[1rem] bg-[#0f4c81] md:basis-1/4 duration-300 hover:opacity-80";return{nav:`<nav class="flex w-full text-[whitesmoke] text-[10px] text-center flex-row md:flex-wrap md:text-[18px]">
    ...
    </footer>`}}function P(t){let e="";return t=="home"?e=`<main class="${d}">
    ...
    </main>`:t=="commission"||t=="contact"||t=="donation"?e="":e=`<main class="${d}">
    ...
    ${f().footer}
  `}let n=window.location.href.split("/");n.pop();n=n.join("/");let h=window.location.href.replace(n+"/","");console.log(h);document.querySelector("#app").innerHTML=`
  ${E(h)}
`;
