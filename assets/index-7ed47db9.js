(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=o(a);fetch(a.href,l)}})();const $="https://avatars.githubusercontent.com/u/25049577?v=4",w="Suphakit Pinyoworapot",k="Suphakit P.",C="Just a Computer Engineering Student w/ some music composing skill. :3",S={bYear:2002,eduProfile:[{grade:"Kintergarden - Grade 6",class:"",school:"Darasamutr Sriracha School",duration:"2005 - 2014"},{grade:"Grade 7-9",class:"MEP",school:"Sriracha School",duration:"2014 - 2018"},{grade:"Grade 10",class:"Sci-Math",school:"Piboonbumpen Demonstration School",duration:"2018 - 2019"},{grade:"Grade 11-12",class:"Sci-Math",school:"Darasamutr Sriracha School",duration:"2019 - April 2021"},{grade:"Bachelor's degree",class:"Computer Engineering",school:"University of Phayao",duration:"May 2021 - Present"}],skills:{programming:["HTML5","CSS3","Bootstrap","Tailwind.css","PHP","Javascript","TypeScript","React.js","Vue.js","Nuxt.js","Express.js"],musicComposing:["Producing","Vocaling","Mastering","Composing","Arranging"]},events:[{name:"TESA Top Gun Rally #16",desp:"5-10 Sept. 2022 @ Chitralada Technology Institute",image:"https://ksrc.suphakit.net/1662866532553/000001.jpg"}],certificates:[{name:"TESA Top Gun Rally #16",desp:"Participate in TESA Top Gun Rally #16",image:""}]},E={musicComposing:[{name:"Let me make a song for you.",desp:"This is a commission for composing a song like 'a theme song' or other type of song",price:"Start @ 1000 THB",example:[{name:"katsu.json - a luv.ly day",link:"https://youtu.be/QjwCHzxqfmE"}]}]},P=[{name:"E-Mail",link:"mailto:me@suphakit.net",bgColor:"#ff6f61",tColor:"whitesmoke"},{name:"Github",link:"https://github.com/dethMastery",bgColor:"#2e2f2f",tColor:"whitesmoke"},{name:"Discord",link:"https://did.000198.xyz/@298415109359796234",bgColor:"#7289da",tColor:"whitesmoke"},{name:"Facebook",link:"https://fb.com/detzz.in.th",bgColor:"#2f89fe",tColor:"whitesmoke"},{name:"Twitter",link:"https://twitter.com/georgeKdeterk",bgColor:"#1c9aee",tColor:"whitesmoke"}],j=[{name:"Promptpay",address:"1209401046979",revName:"Suphakit Pinyoworapot"},{name:"Kasikorn Bank",address:"066-8-69930-8",revName:"Suphakit Pinyoworapot"},{name:"True Wallet",address:"0944264826",revName:"Suphakit Pinyoworapot"}],M={"?":"🤍",year:2023,holder:"Suphakit P.",holderLink:"https://suphakit.net/"},r={image:$,name:w,sName:k,quote:C,about:S,commission:E,contact:P,donation:j,copyright:M};function T(t){let e="",o;return t.forEach(s=>{t.class==""?o=`[${s.grade}] - ${s.school} [${s.duration}]`:o=`[${s.grade}] - ${s.class} ${s.school} [${s.duration}]`,e!=""?e=e+`<li class="mb-[.5rem]">${o}</li>`:e=`<li class="mb-[.5rem]">${o}</li>`}),e}function u(t){let e="";return t.forEach(o=>{e!=""?e=e+", "+o:e=o}),e}function f(t){let e="";return t.forEach(o=>{let s=`<div class="cardEvent">
...
</div>`;e!=""?e=e+s:e=s}),e}function L(t){let e="",o="";return t.forEach(s=>{s.example.forEach(l=>{let i=`<a href='${l.link}' class="underline duration-300 hover:opacity-80 hover:no-underline">${l.name}</a>`;o!=""?o=o+i:o=i});let a=`<div class="commissionCard">
  ...
  <div class="cardBody w-full flex flex-row mt-[2rem]">
...
</div>`;e!=""?e=e+a:e=a}),e}function B(t){let e="";return t.forEach(o=>{let s=`<a href="${o.link}" target="_blank" class="block w-full text-center rounded-[1rem] mb-[1rem] p-[1rem] text-[${o.tColor}] hover:opacity-80" style="background-color: ${o.bgColor};">${o.name}</a>`;e!=""?e=e+s:e=s}),e}let m="w-[100%] flex flex-col md:flex-row",h="w-[100%] mb-[5rem]",d="text-3xl mb-[1rem]",n="text-2xl mb-[1rem] underline",p="text-xl mb-[1rem] underline",g="container w-[80%] mx-auto",b="header my-[5rem] w-full justify-center text-center text-[whitesmoke]",v="content p-[2rem] bg-[whitesmoke] w-full rounded-[1rem]";function x(){let t="block w-full basis-1/2 py-[1rem] bg-[#0f4c81] md:basis-1/4 duration-300 hover:opacity-80";return{nav:`<nav class="flex w-full text-[whitesmoke] text-[10px] text-center flex-row md:flex-wrap md:text-[18px]">
    ...
    </footer>`}}function N(t){let e="";return t=="home"||t==""?e=`<main class="${m}">
      ...
      <div class="${g}">
        ...
        <div class="${v}">
          ...
          <div class="skill mb-[2rem]">
            ...
            ${u(r.about.skills.programming)}
            <br><br>
            <h3 class="${p}">
              Music Composing
            </h3>
            ${u(r.about.skills.musicComposing)}
          </div>
    ...
    </main>`:t=="commission"?e=`<main class="${h}">
      <div class="${g}">
        <div class="${b}">
          <h1 class="${d}">
            commission()
    ...
    </main>`:t=="donation"?e="":e=`<main class="${m}">
